...
for i in range(len(lines)):
    if mode == "multi":
        if "Dynamic Rulebook Rhos" in lines[i]:
            ...
            result_count_0[curr_source].append(
                val1[0] * 16 + val1[1] * 8 + val1[2] * 4 + val1[4] * 2 + val1[3] * 1
            )
            if (
                tuple(1 * np.array([val1[0], val1[1], val1[2], val1[4], val1[3]]))
            ...
            result_count_1[curr_source].append(
                val2[0] * 4 + val2[1] * 4 + val2[2] * 4 + val2[3] * 2 + val2[4] * 1
            )
            if (
                tuple(1 * np.array([val2[0], val2[1], val2[2], val2[3], val2[4]]))
            ...
            result_count_2[curr_source].append(
                val3[0] * 8 + val3[1] * 4 + val3[2] * 2 + val3[3] * 1
            )
            if (
                tuple(1 * np.array([val3[0], val3[1], val3[2], val3[3]]))
                in counterexample_type_2[curr_source]
            ):
                counterexample_type_2[curr_source][
                    tuple(1 * np.array([val3[0], val3[1], val3[2], val3[3]]))
                ] += 1
            else:
                counterexample_type_2[curr_source][
        ...
        if "Dynamic Rulebook Rhos" in lines[i]:
            ...
            result_count_0[curr_source].append(
                val1[0] * 16 + val1[3] * 8 + val1[4] * 4 + val1[7] * 2 + val1[6] * 1
            )
            if (
                tuple(1 * np.array([val1[0], val1[3], val1[4], val1[7], val1[6]]))
                in counterexample_type_0[curr_source]
            ):
                counterexample_type_0[curr_source][
                    tuple(1 * np.array([val1[0], val1[3], val1[4], val1[7], val1[6]]))
            ...
            result_count_1[curr_source].append(
                val2[0] * 4 + val2[1] * 4 + val2[2] * 4 + val2[3] * 2 + val2[8] * 1
            )
            if (
                tuple(1 * np.array([val2[0], val2[1], val2[2], val2[3], val2[8]]))
                in counterexample_type_1[curr_source]
            ):
                counterexample_type_1[curr_source][
                    tuple(1 * np.array([val2[0], val2[1], val2[2], val2[3], val2[8]]))
            ...
            result_count_2[curr_source].append(
                val3[0] * 8 + val3[3] * 4 + val3[5] * 2 + val3[6] * 1
            )
            if (
                tuple(1 * np.array([val3[0], val3[3], val3[5], val3[6]]))
                in counterexample_type_2[curr_source]
            ):
                counterexample_type_2[curr_source][
                    tuple(1 * np.array([val3[0], val3[3], val3[5], val3[6]]))
