    ...
    if mode == "multi":
        if "Dynamic Rulebook Rhos" in lines[i]:
            ...
            result_count_0[curr_source].append(
                val1[0] * 8 + val1[1] * 4 + val1[3] * 2 + val1[2] * 1
            )
            if (
                tuple(1 * np.array([val1[0], val1[1], val1[3], val1[2]]))
            ...
            if (
                tuple(
                    1
                    * np.array(
                        [val2[0], val2[1], val2[2], val2[3], val2[4], val2[5], val2[6]]
                    )
                )
            ...
            result_count_2[curr_source].append(
                val3[0] * 4 + val3[1] * 4 + val3[2] * 4 + val3[3] * 2 + val3[4] * 1
            )
            if (
                tuple(1 * np.array([val3[0], val3[1], val3[2], val3[3], val3[4]]))
        ...
        if "Dynamic Rulebook Rhos" in lines[i]:
            ...
            result_count_0[curr_source].append(
                val1[1] * 8 + val1[5] * 4 + val1[7] * 2 + val1[6] * 1
            )
            if (
                tuple(1 * np.array([val1[1], val1[5], val1[7], val1[6]]))
                in counterexample_type_0[curr_source]
            ):
                counterexample_type_0[curr_source][
                    tuple(1 * np.array([val1[1], val1[5], val1[7], val1[6]]))
            ...
            if (
                tuple(
                    1
                    * np.array(
                        [val2[0], val2[1], val2[2], val2[3], val2[4], val2[5], val2[8]]
                    )
                )
                in counterexample_type_1[curr_source]
            ):
            ...
            result_count_2[curr_source].append(
                val3[2] * 4 + val3[3] * 4 + val3[4] * 4 + val3[5] * 2 + val3[6] * 1
            )
            if (
                tuple(1 * np.array([val3[2], val3[3], val3[4], val3[5], val3[6]]))
                in counterexample_type_2[curr_source]
            ):
                counterexample_type_2[curr_source][
                    tuple(1 * np.array([val3[2], val3[3], val3[4], val3[5], val3[6]]))
